...
#Open Data files
with open(r'E:\Dropbox\Yana\YanaPlottingProject\RoundEight\Watershed Data MASTER_v11.txt') as csvfile:
...
#                curDir = saveDir+'Location\\'+plotLocation[0]
            ...
            try:
                if len(plotUnit) != 0 and len(plotResults) != 0 and os.path.isfile(imageName) == False:
                    ...
                    figure = plt.plot(plotdataTime,[float(i) for i in plotResults], marker='.', markersize=10)
